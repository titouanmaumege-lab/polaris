...
### S2 — ÉLEVÉ (CONFIRMÉ au dashboard) : table `profiles` lisible par n'importe qui
...
### S3 — ÉLEVÉ : fuite de données entre comptes sur un même navigateur
...
### S4 — MOYEN : aucun header de sécurité
...
### S6 — MOYEN : politique de mots de passe faible (CONFIRMÉ au dashboard)
